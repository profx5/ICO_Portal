...
from user_office.models import Transfer, TokensMove, Payment
...
class TestProcessTransfer(BlockChainTestCase):
    ...
    def test_transfer_tokens_to_existing_investor(self):
        ...
        event = self.get_transfer_event_by_receipt('0xd04dff3daa89a5898793cd426e95e2ed39d1cccc19e1213e815aca97a0d9c0f0')
        processor = ProcessTransfer()
    ...
    def test_transfer_between_nonexisting_accounts(self):
        ...
        tokens_moves = TokensMove.objects.all()
        self.assertEqual(tokens_moves.count(), 0)
