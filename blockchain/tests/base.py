...
class BlockChainTestCase(TestCase):
    _compiled_token_contract_path = f'{settings.BASE_DIR}/solidity-contracts/contracts/VeraCoin.json'
    _compiled_crowdsale_contract_path = f'{settings.BASE_DIR}/solidity-contracts/contracts/KYCCrowdsale.json'
