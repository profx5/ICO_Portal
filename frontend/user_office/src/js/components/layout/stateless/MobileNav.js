...
const MobileNav = ({changeSupportActiveTab, onClickHandler}) => {

    return (
        <Wrapper>
            <StyledLink exact activeClassName="active" to="/user_office" onClick={onClickHandler}>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="24" viewBox="0 0 28 24">
                        <g fill="#3172FD" fillRule="nonzero">
                            <path d="M27.334 5.525L14.434.087a1.117 1.117 0 0 0-.867 0L.666 5.525A1.08 1.08 0 0 0 0 6.52c0 .433.264.823.668.993l12.901 5.402a1.117 1.117 0 0 0 .862 0l12.9-5.402c.406-.17.669-.56.669-.993a1.08 1.08 0 0 0-.666-.994zM14 10.745L3.896 6.516 14 2.255l10.104 4.26L14 10.745zM27.91 17.603c-.239-.505-.886-.739-1.443-.522L14 21.922l-12.467-4.84c-.559-.218-1.204.017-1.444.521-.24.505.02 1.09.577 1.307l12.9 5.01a1.2 1.2 0 0 0 .868 0l12.9-5.01c.558-.217.816-.802.577-1.307z"/>
            ...
            <StyledLink activeClassName="active" to="/user_office/transactions" onClick={onClickHandler}>
                <div>
            ...
            <StyledLink onClick={changeSupportActiveTab.bind(this, 1)} activeClassName="active" to="/user_office/support" onClick={onClickHandler}>
                <div>
