...

{
  ...
  if (document.querySelector('.PartnersSection_slider')) {
  ...
  let MainNewsSliderInst = new Swiper($('.MainSection_sliderContainer'), {
    spaceBetween: 50,
    autoplay: true,
    speed: 1000,
    delay: 3500,
    loop: true,
    pagination: {
      el: '.MainSection_pagination',
      bulletClass: 'MainSection_bullet',
      bulletActiveClass: 'MainSection_bullet-active',
      clickable: true
    },
    on: {
      init: () => {
        $('.MainSection_sliderContainer').removeClass('MainSection_sliderContainer-hidden');
      }
    }
  });
